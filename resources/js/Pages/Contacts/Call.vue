...
var socket = io.connect("https://demo.unixlocal.tk:8888")
            ...
            myPeer: new Peer(
                {
                    config: {
                        'iceServers': [
                            { url: process.env.MIX_STUN_SERVER + ':' + process.env.MIX_STUN_PORT },
                            { url: process.env.MIX_TURN_SERVER + ':' + process.env.MIX_TURN_PORT, username: process.env.MIX_TURN_USER, credential: process.env.MIX_TURN_PASS }
                        ]
                    }
                }),
            myStream: '',
