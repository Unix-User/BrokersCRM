<template>
  ...
  <svg v-else-if="name === 'home'" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 20 20"><g transform="matrix(0.042895, 0, 0, 0.042895, 0.024631, 0.618968)" style=""/><g transform="matrix(1.109823, 0, 0, 1.109823, -3.310176, -3.328848)" style=""><path d="M12 3L4 9v12h5v-7h6v7h5V9z"/></g></svg>
</template>
