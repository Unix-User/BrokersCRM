        ...
        <div class="md:flex md:flex-shrink-0">
            ...
            <dropdown class="mt-1" placement="bottom-end">
              <template #default>
                <div class="group flex items-center cursor-pointer select-none">
                  ...
                  <icon class="w-5 h-5 fill-gray-700 group-hover:fill-green-600 focus:fill-green-600"
                    name="cheveron-down" />
                </div>
              </template>
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  <Link class="block px-6 py-2 hover:text-white hover:bg-green-500"
                    :href="`/users/${auth.user.id}/edit`">Meu Perfil</Link>
                  <Link class="block px-6 py-2 hover:text-white hover:bg-green-500" href="/users">Gerenciar Usuários
                  </Link>
                  <Link class="block px-6 py-2 w-full text-left hover:text-white hover:bg-green-500" href="/logout"
                    method="delete" as="button">Sair</Link>
                </div>
              </template>
            </dropdown>
          </div>
          <div v-else
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  <Link class="block px-6 py-2 hover:text-white hover:bg-green-500" href="/login">Login</Link>
                  <Link class="block px-6 py-2 hover:text-white hover:bg-green-500" href="/register">Registre-se
                  </Link>
                </div>
              </template>
            </dropdown>
